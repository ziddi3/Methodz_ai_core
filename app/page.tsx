  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-8">
      <div className="max-w-4xl text-center">
        ...
        <p className="text-xl mb-8 text-gray-300">Persistent multi-provider intelligence workspace</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="p-6 border border-gray-800 rounded-2xl">
            ...
            <p className="text-gray-400">Taru · Tartus catboy surface</p>
          </div>
        </div>
        ...
        <p className="mt-8 text-xs text-gray-500">Built from the manifesto · Provider independent · agent:tartus</p>
      </div>
    </div>
  );
}
